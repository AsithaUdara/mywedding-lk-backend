...
namespace MyWedding.Infrastructure.Migrations
{
    ...
    [Migration("20260614195227_AddPlannerTaskTemplates")]
    partial class AddPlannerTaskTemplates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyWedding.Domain.Entities.PlannerTaskTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PlannerTaskTemplates");
                });

            modelBuilder.Entity("MyWedding.Domain.Entities.PlannerTaskTemplateItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("DependsOnSortOrder")
                        .HasColumnType("int");
                    ...
                    b.ToTable("PlannerTaskTemplateItems");
                });
            ...
            modelBuilder.Entity("MyWedding.Domain.Entities.PlannerTaskTemplate", b =>
                {
                    ...
                    b.HasOne("MyWedding.Domain.Entities.WeddingEvent", "SourceEvent")
                        .WithMany()
            ...
            modelBuilder.Entity("MyWedding.Domain.Entities.PlannerTaskTemplateItem", b =>
                {
                    b.HasOne("MyWedding.Domain.Entities.PlannerTaskTemplate", "Template")
                        .WithMany("Items")
